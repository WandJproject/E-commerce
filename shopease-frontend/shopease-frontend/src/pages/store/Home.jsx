...
import { Truck, ShieldCheck, Headset, Laptop, Shirt, Footprints, Home as HomeIcon, Sparkles, Dumbbell, Watch, MoreHorizontal } from 'lucide-react'
    ...
    <div>
        ...
        <div className="grid lg:grid-cols-[1fr_260px] gap-4">
          <div className="relative bg-neutral-100 rounded-2xl overflow-hidden grid md:grid-cols-2 items-center">
            <div className="p-8 md:p-12 z-10">
              ...
              <div className="flex gap-3">
                ...
                <Link to="/shop?filter=deals" className="btn-outline bg-white">Explore Deals</Link>
              </div>
            </div>
            <div className="hidden md:block h-full">
              <img
                src="https://images.unsplash.com/photo-1552374196-c4e7ffc6e126?w=700&q=80"
          ...
          <div className="hidden lg:flex flex-col gap-4">
            <div className="card p-4 flex items-center gap-3">
              <span className="bg-accent-soft text-accent p-2 rounded-lg"><Truck size={20} /></span>
              <div>
            ...
            <div className="card p-4 flex items-center gap-3">
              <span className="bg-green-50 text-green-600 p-2 rounded-lg"><ShieldCheck size={20} /></span>
              <div>
            ...
            <div className="card p-4 flex items-center gap-3">
              <span className="bg-purple-50 text-purple-600 p-2 rounded-lg"><Headset size={20} /></span>
              <div>
                <p className="text-sm font-semibold">24/7 Support</p>
                <p className="text-xs text-neutral-500">We support online 24/7</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="container-page py-10">
        <div className="flex flex-wrap justify-between gap-6">
          ...
          <Link to="/shop" className="flex flex-col items-center gap-2 w-20 text-center group">
            <span className="w-14 h-14 rounded-full bg-neutral-100 grid place-items-center group-hover:bg-accent-soft group-hover:text-accent transition-colors">
      ...
      <section className="bg-brand text-white">
        <div className="container-page py-6 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div>
            ...
            <p className="text-xs text-neutral-400">We sell original products</p>
          </div>
          <div>
            <p className="font-semibold text-sm">14-Day Return</p>
            <p className="text-xs text-neutral-400">14 day money back guarantee</p>
          </div>
          <div>
            <p className="font-semibold text-sm">Pay On Delivery</p>
            <p className="text-xs text-neutral-400">Cash on delivery available</p>
          </div>
          <div>
